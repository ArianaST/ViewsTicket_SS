                ...
                >
                  <textarea>
                    <div class="leading-relaxed">
                        ...
                        <div class="w-full h-64 my-5 image-fit">
                            <img alt="Rubick Tailwind HTML Admin Template" :src="$f()[0].images[0]" data-action="zoom" class="w-full rounded-md">
                        </div>
                        <p class="mb-5">
                            Thundercats freegan Truffaut, four loko twee Austin scenester
                            lo-fi seitan High Life paleo quinoa cray. Schlitz butcher
                        ...
                        <div class="w-3/5 h-64 mr-6 float-left image-fit">
                            <img alt="Rubick Tailwind HTML Admin Template" :src="$f()[0].images[1]" data-action="zoom" class="w-full rounded-md">
                        </div>
                        <p class="mb-5">
                            Scenester chambray slow-carb, trust fund biodiesel ugh bicycle
                            rights cornhole. Gentrify messenger bag Truffaut tousled roof
