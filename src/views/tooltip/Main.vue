              ...
              >
                ...
                >
                  <textarea>
                    <!-- BEGIN: Custom Tooltip Toggle -->
                    <div class="text-center">
                        <a href="javascript:;" name="custom-tooltip-content" class="tooltip btn btn-primary">Show Tooltip</a>
                    </div>
                    <!-- END: Custom Tooltip Toggle -->
                    <!-- BEGIN: Custom Tooltip Content -->
                    <div class="tooltip-content">
                        <TippyContent to="custom-tooltip-content">
                            <div id="custom-content-tooltip" class="relative flex items-center py-1">
                                <div class="w-12 h-12 image-fit">
                                    <img alt="Rubick Tailwind HTML Admin Template" class="rounded-full" :src="$f()[0].photos[0]">
                                </div>
                                <div class="ml-4 mr-auto">
              ...
              <Highlight id="copy-chart-preview-tooltip" class="source-preview">
                ...
                >
                  <textarea>
                    <!-- BEGIN: Custom Tooltip Toggle -->
                    <div class="text-center">
                        <a href="javascript:;" name="chart-tooltip" class="tooltip btn btn-primary">Show Tooltip</a>
                    </div>
                    <!-- END: Custom Tooltip Toggle -->
                    <!-- BEGIN: Custom Tooltip Content -->
                    <div class="tooltip-content">
