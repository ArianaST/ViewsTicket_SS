                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu w-56">
                            <ul class="dropdown-content">
                                ...
                                <li>
                                    <a href="" class="dropdown-item">
                                        <ActivityIcon class="w-4 h-4 mr-2" /> English
                                    </a>
                                </li>
                                <li>
                                    <a href="" class="dropdown-item">
                                ...
                                <li>
                                    <a href="" class="dropdown-item">
                                        <LayoutIcon class="w-4 h-4 mr-2" /> English
                                    </a>
                                </li>
                                <li>
                                    <a href="" class="dropdown-item">
                                        <SidebarIcon class="w-4 h-4 mr-2" /> Indonesia
                                    </a>
                                </li>
                                <li>
                                    <hr class="dropdown-divider">
        ...
        <div id="programmatically-show-hide-dropdown" class="p-5">
          <div class="preview">
            <div class="text-center">
              ...
              <button
                id="programmatically-show-dropdown"
                class="btn btn-primary w-40 mr-1 mb-2"
                @click="show"
              >
                Show
              </button>
              ...
              <button
                id="programmatically-hide-dropdown"
                class="btn btn-primary w-40 mr-1 mb-2"
                @click="hide"
              >
                Hide
              ...
              <button
                id="programmatically-toggle-dropdown"
                class="btn btn-primary w-40 mr-1 mb-2"
                @click="toggle"
              >
                Toggle
          ...
          <div class="source-code hidden">
            ...
            <div class="overflow-y-auto mt-3 rounded-md">
              ...
              >
                ...
                >
                  <textarea>
                    <!-- BEGIN: Show Modal Toggle -->
                    <button id="programmatically-show-dropdown" class="btn btn-primary w-40 mr-1 mb-2" @click="show">Show</button>
                    <!-- END: Show Modal Toggle -->
                    <!-- BEGIN: Hide Modal Toggle -->
                    <button id="programmatically-hide-dropdown" class="btn btn-primary w-40 mr-1 mb-2" @click="hide">Hide</button>
                    <!-- END: Hide Modal Toggle -->
                    <!-- BEGIN: Toggle Modal Toggle -->
                    <button id="programmatically-toggle-dropdown" class="btn btn-primary w-40 mr-1 mb-2" @click="toggle">Toggle</button>
                    <!-- END: Toggle Modal Toggle -->
                    <!-- BEGIN: Dropdown Content -->
            ...
            <div class="overflow-y-auto mt-3 rounded-md">
              <Highlight
                id="copy-programmatically-show-hide-dropdown-js"
                class="source-preview"
              >
                <code
      ...
      <div class="intro-y box mt-5">
        ...
        <div id="header-icon-dropdown" class="p-5">
          ...
          <div class="source-code hidden">
            ...
            <div class="overflow-y-auto mt-3 rounded-md">
              <Highlight id="copy-header-icon-dropdown" class="source-preview">
                <code
                  class="text-xs p-0 rounded-md html pl-5 pt-8 pb-4 -mb-10 -mt-10"
                >
                  <textarea>
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu w-40">
                            <ul class="dropdown-content">
                                ...
                                <li>
                                    <a href="" class="dropdown-item">
                                        <ExternalLinkIcon class="w-4 h-4 mr-2" /> Excel
                                    </a>
                                </li>
                                <li>
                                    <a href="" class="dropdown-item">
                                ...
                                <li>
                                    <a href="" class="dropdown-item">
                                        <ArchiveIcon class="w-4 h-4 mr-2" /> PDF
                                    </a>
                                </li>
                            </ul>
                        </div>
