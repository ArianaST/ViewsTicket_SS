                                        ...
                                        >
                                            <div class="h-56 px-2">
                                                <div class="h-full image-fit rounded-md overflow-hidden">
                                                    <img alt="Rubick Tailwind HTML Admin Template" :src="$f()[0].images[0]" />
                                                </div>
                                            </div>
                                            <div class="h-56 px-2">
                                                <div class="h-full image-fit rounded-md overflow-hidden">
                                                    <img alt="Rubick Tailwind HTML Admin Template" :src="$f()[0].images[1]" />
                                                </div>
                                            </div>
                                            <div class="h-56 px-2">
                                                <div class="h-full image-fit rounded-md overflow-hidden">
                                                    <img alt="Rubick Tailwind HTML Admin Template" :src="$f()[0].images[2]" />
                                                </div>
                                            </div>
                                            <div class="h-56 px-2">
                                                <div class="h-full image-fit rounded-md overflow-hidden">
                                                    <img alt="Rubick Tailwind HTML Admin Template" :src="$f()[0].images[3]" />
                                                </div>
                                            </div>
                                        </TinySlider>
                                    </div>
