              ...
              >
                ...
                >
                  <textarea>
                    ...
                    <!-- END: Notification Content -->
                    <!-- BEGIN: Notification Toggle -->
                    <button id="basic-non-sticky-notification-toggle" class="btn btn-primary mr-1" @click="basicNonStickyNotificationToggle">Show Non Sticky Notification</button>
                    <button id="basic-sticky-notification-toggle" class="btn btn-primary mt-2 sm:mt-0" @click="basicStickyNotificationToggle">Show Sticky Notification</button>
                    <!-- END: Notification Toggle -->
                  </textarea>
                </code>
              </Highlight>
              ...
              >
                ...
                >
                  <textarea>
                    ...
                    <!-- END: Notification Content -->
                    <!-- BEGIN: Notification Toggle -->
                    <button id="success-notification-toggle" class="btn btn-primary" @click="successNotificationToggle">Show Notification</button>
                    <!-- END: Notification Toggle -->
                  </textarea>
                </code>
              </Highlight>
              ...
              >
                ...
                >
                  <textarea>
                    ...
                    <!-- END: Notification Content -->
                    <!-- BEGIN: Notification Toggle -->
                    <button id="notification-with-actions-toggle" class="btn btn-primary" @click="notificationWithActionsToggle">Show Notification</button>
                    <!-- END: Notification Toggle -->
                  </textarea>
                </code>
              </Highlight>
                  ...
                  <textarea>
                    ...
                    <div id="notification-with-avatar-content" class="toastify-content hidden flex">
                        <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                            <img alt="Rubick Tailwind HTML Admin Template" :src="$f()[0].photos[0]">
                        </div>
                        <div class="ml-4 sm:mr-28">
                            <div class="font-medium">
                                {{ $f()[0].users[0].name }}
                    ...
                    <!-- END: Notification Content -->
                    <!-- BEGIN: Notification Toggle -->
                    <button id="notification-with-avatar-toggle" class="btn btn-primary" @click="notificationWithAvatarToggle">Show Notification</button>
                    <!-- END: Notification Toggle -->
                  </textarea>
                </code>
              </Highlight>
                ...
                >
                  <textarea>
                    ...
                    $("#notification-with-avatar-toggle").on("click", function () {
                        ...
                        dom(avatarNotification.toastElement)
              ...
              >
                ...
                >
                  <textarea>
                    ...
                    <!-- END: Notification Content -->
                    <!-- BEGIN: Notification Toggle -->
                    <button id="notification-with-split-buttons-toggle" class="btn btn-primary" @click="notificationWithSplitButtonsToggle">Show Notification</button>
                    <!-- END: Notification Toggle -->
                  </textarea>
                </code>
              </Highlight>
                ...
                >
                  <textarea>
                    ...
                    $("#notification-with-split-buttons-toggle").on("click", function () {
                        ...
                        // Close notification event
                        dom(splitButtonsNotification.toastElement)
                            .find(\'[data-dismiss="notification"]\')
                            .on("click", function () {
              ...
              >
                ...
                >
                  <textarea>
                    ...
                    <!-- END: Notification Content -->
                    <!-- BEGIN: Notification Toggle -->
                    <button id="notification-with-buttons-below-toggle" class="btn btn-primary" @click="notificationWithButtonsBelowToggle">Show Notification</button>
                    <!-- END: Notification Toggle -->
                  </textarea>
                </code>
              </Highlight>
...
const notificationWithActionsToggle = () => {
  Toastify({
    node: dom("#notification-with-actions-content")
      .clone()
      .removeClass("hidden")[0],
    duration: -1,
    newWindow: true,
...
const notificationWithAvatarToggle = () => {
  ...
  const avatarNotification = Toastify({
    node: dom("#notification-with-avatar-content")
      .clone()
      .removeClass("hidden")[0],
    duration: -1,
    newWindow: true,
...
const notificationWithSplitButtonsToggle = () => {
  ...
  const splitButtonsNotification = Toastify({
    node: dom("#notification-with-split-buttons-content")
      .clone()
      .removeClass("hidden")[0],
    duration: -1,
    newWindow: true,
...
const notificationWithButtonsBelowToggle = () => {
  // Init toastify
  Toastify({
    node: dom("#notification-with-buttons-below-content")
      .clone()
      .removeClass("hidden")[0],
    duration: -1,
    newWindow: true,
