      ...
      <div class="intro-y box mt-5">
        ...
        <div id="icon-alert" class="p-5">
          <div class="preview">
            ...
            <div
              class="alert alert-pending show flex items-center mb-2"
              role="alert"
            >
              <AlertTriangleIcon class="w-6 h-6 mr-2" /> Awesome alert with icon
            </div>
      ...
      <div class="intro-y box">
        ...
        <div id="icon-dismiss-alert" class="p-5">
          <div class="preview">
            ...
            <div
              class="alert alert-pending alert-dismissible show flex items-center mb-2"
              role="alert"
            >
              <AlertTriangleIcon class="w-6 h-6 mr-2" /> Awesome alert with icon
              <button
      ...
      <div class="intro-y box mt-5">
        ...
        <div id="outline-alert" class="p-5">
          <div class="preview">
            ...
            <div
              class="alert alert-outline-pending alert-dismissible show flex items-center mb-2"
              role="alert"
            >
              <AlertCircleIcon class="w-6 h-6 mr-2" /> Awesome alert with icon
              <button
      ...
      <div class="intro-y box mt-5">
        ...
        <div id="softcolor-alert" class="p-5">
          <div class="preview">
            ...
            <div
              class="alert alert-pending-soft show flex items-center mb-2"
              role="alert"
            >
              <AlertTriangleIcon class="w-6 h-6 mr-2" /> Awesome alert with icon
            </div>
