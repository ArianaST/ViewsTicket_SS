            ...
            <div class="overflow-y-auto mt-3 rounded-md">
              <Highlight id="copy-loading-button" class="source-preview">
                ...
                >
                  <textarea>
                    <button class="btn btn-primary mr-1 mb-2">
                        Saving <LoadingIcon icon="oval" color="white" class="w-4 h-4 ml-2" />
                    </button>
                    <button class="btn btn-success mr-1 mb-2">
                        Adding <LoadingIcon icon="spinning-circles" color="white" class="w-4 h-4 ml-2" />
                    </button>
                    <button class="btn btn-warning mr-1 mb-2">
                        Loading <LoadingIcon icon="three-dots" color="1a202c" class="w-4 h-4 ml-2" />
                    </button>
                    <button class="btn btn-danger mr-1 mb-2">
                        Deleting <LoadingIcon icon="puff" color="white" class="w-4 h-4 ml-2" />
                    </button>
                  </textarea>
                </code>
              </Highlight>
